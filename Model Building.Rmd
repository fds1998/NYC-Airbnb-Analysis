...
predicted_medium = predict.glm(logit_medium, test_data_logit, type = "response")
...
```{r}
predicted_expensive = predict.glm(logit_expensive, test_data_logit, type = "response")
...
```{r}
predicted_very_expensive = predict.glm(logit_very_expensive, test_data_logit, type = "response")
