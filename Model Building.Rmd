...
model_four_cv <- train(price ~ neighbourhood_group + room_type + minimum_nights + number_of_reviews + reviews_per_month + calculated_host_listings_count + availability_365 + miles , data = airbnb_new_model,trainControl = train.control,method = "lm") # Everything apart from miles

print(model_four_cv)

# R^2 = 0.4961, RMSE = 41.51
...
airbnb_lasso[,8:236] <- lapply(airbnb_lasso[,8:236], as.factor)
...
best_model$dev.ratio #0.559 R2. Better than simple linear regression model four
